...
| `08_DATASETS/` | Métadonnées | Jeux de données référencés et sourcés |
| `06_RESEARCH/` | Métadonnées | Bibliographie sourcée |
...
| Type | Cible | Nature |
|---|---|---|
| Bases externes | `08_DATASETS/`, `06_RESEARCH/` | Sources de métadonnées et bibliographie |

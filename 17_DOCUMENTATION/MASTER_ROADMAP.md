...
| RFC-0004 (GSIE-FEU) activé | Branche incendie spécifiée |

## Phase 3 — Connaissance

| Jalons | Critère de succès |
|---|---|
| Base de connaissances structurée | `07_KNOWLEDGE/` peuplé et sourcé |
...
| Jeux de données référencés | `08_DATASETS/` qualifié |

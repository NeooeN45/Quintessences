...
### État d'exécution vérifié — 2026-07-26
...
| **Migration v6.2** — **RFC-0012 + DEC-000023 + ADR-007** | ✅ **Implémenté (2026-07-16)** | 76 types SQLAlchemy, table racine resource, CRUD générique 8 endpoints, WebSocket auth JWT + Redis Pub/Sub, 17 tables de jonction n:m, Outbox/Inbox (ADR-005), Object Storage (ADR-006), validation dynamique, soft delete (CON-010), 194 tests passent. **Historique Alembic assaini** : baseline immuable `20260726_0001` validée sur une base vierge (DEC-000036). |
...
- geoOrchestra : source géospatiale externe potentielle future, classée
  en veille (priorité 3) ; éventuel connecteur OGC/API vers le GIS Engine,
  sans dépendance directe ni statut de source de vérité

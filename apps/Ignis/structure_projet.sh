...
Banc hors dépôt principal (voir `a:/GSIE/apps/Ignis/`).
README
...
cp /mnt/a/GSIE/apps/Ignis/*.py scripts/ 2>/dev/null || true
cp /mnt/a/GSIE/apps/Ignis/*.sh scripts/ 2>/dev/null || true
cp /mnt/a/GSIE/apps/Ignis/run_test.sh scripts/ 2>/dev/null || true

...
def main():
    json_path = sys.argv[1] if len(sys.argv) > 1 else "/mnt/a/GSIE/apps/Ignis/captures_forefire_temps_reel.json"
    output_path = sys.argv[2] if len(sys.argv) > 2 else "/mnt/a/GSIE/apps/Ignis/trajet_forefire_temps_reel.png"

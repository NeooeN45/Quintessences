...
- **Ignis Jalon 0** — Cartographie de l'existant : comparatif sourcé des briques + matrice capteurs + comparatif comms (C-05). *(en cours — voir `22_PROJECT_MEMORY/Ignis/` pour les livrables produits)*

#!/bin/bash
# GSIE-Ignis — Structure projet + git init
...
# GSIE-Ignis — Banc de simulation drone + feu
...
Banc hors dépôt principal (voir `a:/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/`).
README
...
cp /mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/*.py scripts/ 2>/dev/null || true
cp /mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/*.sh scripts/ 2>/dev/null || true
cp /mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/run_test.sh scripts/ 2>/dev/null || true

"""GSIE-Ignis — Visualisation des trajectoires de vol.
...
if __name__ == "__main__":
    input_path = sys.argv[1] if len(sys.argv) > 1 else \
        "/mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/captures_surveillance.json"
    output_path = sys.argv[2] if len(sys.argv) > 2 else \
        "/mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/trajectoire_surveillance.png"

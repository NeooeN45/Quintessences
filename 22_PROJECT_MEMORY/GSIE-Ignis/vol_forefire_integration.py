"""GSIE-Ignis — Intégration ForeFire + drone : surveillance de feu.
...
FF_SCRIPT = "/mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/surveillance_incendie.ff"
...
async def run() -> None:
    ...
    output_path = "/mnt/a/GSIE/22_PROJECT_MEMORY/GSIE-Ignis/captures_forefire_integration.json"
    output_data = {

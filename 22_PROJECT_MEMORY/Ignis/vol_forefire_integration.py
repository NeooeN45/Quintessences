...
FF_SCRIPT = "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/surveillance_incendie.ff"
...
async def run() -> None:
    ...
    output_path = "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/captures_forefire_integration.json"
    output_data = {

...
def main():
    json_path = sys.argv[1] if len(sys.argv) > 1 else "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/captures_forefire_temps_reel.json"
    output_path = sys.argv[2] if len(sys.argv) > 2 else "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/trajet_forefire_temps_reel.png"
    ...
    ax.set_title(f"Ignis — Surveillance feu ForeFire (temps réel)\n"

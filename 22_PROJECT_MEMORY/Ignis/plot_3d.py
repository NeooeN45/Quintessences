"""Ignis — Visualisation 3D des trajectoires + fronts de feu ForeFire.
...
if __name__ == "__main__":
    input_path = sys.argv[1] if len(sys.argv) > 1 else \
        "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/captures_forefire_integration.json"
    output_path = sys.argv[2] if len(sys.argv) > 2 else \
        "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/visualisation_3d.png"

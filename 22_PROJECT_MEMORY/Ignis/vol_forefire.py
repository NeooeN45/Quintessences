"""Ignis — Vol drone + simulation ForeFire temps réel.
...
OUTPUT_JSON = "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/captures_forefire_temps_reel.json"
OUTPUT_PLOT = "/mnt/a/GSIE/22_PROJECT_MEMORY/Ignis/trajet_forefire_temps_reel.png"
...
def plot_results(captures: list) -> None:
    ...
    ax.set_title("Ignis — Surveillance feu ForeFire (temps réel)", fontsize=14)

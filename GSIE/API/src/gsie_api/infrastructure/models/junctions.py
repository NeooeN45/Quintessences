...
model_run_input = Table(
    ...
    Column("model_run_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
conflict_cluster_assertion = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("conflict_cluster_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
hypothesis_supporting = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("hypothesis_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
    Column("assertion_id", PGUUID(as_uuid=True), ForeignKey("resource.id"), nullable=False),
...
decision_recommendation = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("decision_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
recommendation_assertion = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("recommendation_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
    Column("assertion_id", PGUUID(as_uuid=True), ForeignKey("resource.id"), nullable=False),
...
feature_set_feature = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("feature_set_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
experiment_scenario = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("experiment_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
    Column("scenario_id", PGUUID(as_uuid=True), ForeignKey("resource.id"), nullable=False),
...
ecological_state_basis = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("ecological_state_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
correlation_variable = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("correlation_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
knowledge_lineage_derived = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("knowledge_lineage_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),
...
terrain_session_sampling = Table(
    ...
    Base.metadata,
    Column("id", Integer, primary_key=True, autoincrement=True),
    Column("terrain_session_id", PGUUID(as_uuid=True), ForeignKey("resource.id", ondelete="CASCADE"), nullable=False),

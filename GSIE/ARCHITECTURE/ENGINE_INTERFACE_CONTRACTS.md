...
- `GSIE/ENGINES/*/` — documentation détaillée de chaque moteur
- `GSIE/ARCHITECTURE/ENGINE_COMMUNICATION_PROTOCOL.md` — protocole d'échange
- `GSIE/ARCHITECTURE/GSIE_DATA_FLOW.md` — flux de données global
...
chaque document moteur (`GSIE/ENGINES/*/ENGINE.md` §5). Ils sont la

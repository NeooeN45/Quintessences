...
| **Documents connexes** | `GSIE_IGNIS_GCS_CINEMA_UNREAL.md` (livrable 211, GCS-Cinéma UE 5.8), `GSIE_IGNIS_DATA_PIPELINE.md`, `GSIE_IGNIS_DRONE_ARCHITECTURE.md`, `apps/Ignis/REGISTRE.md` (registre d'idées), `apps/Ignis/Phase0_comparatif_moteurs_simulation.md` |
...
- `apps/Ignis/REGISTRE.md` — Registre d'idées (60+ idées, 9
  sections)
- `apps/Ignis/Phase0_comparatif_moteurs_simulation.md`
  — Comparatif sourcé Phase 0
- `apps/Ignis/guide_installation_banc.md` — Guide
  d'installation
- `apps/Ignis/journal.md` — Journal de bord

...
`GSIE/ENGINES/*/`) ni les contrats d'interface (voir livrable 206,
...
|---|---|
| Evidence Engine | Évaluer la qualité scientifique (niveau de preuve) de chaque connaissance entrante. *Réf. : `GSIE/RESEARCH/RESEARCH_METHOD.md` (pipeline d'évaluation), `SCIENTIFIC_CONSTITUTION.md` art. S-2 (niveaux A à F)* |
| Knowledge Engine | Centraliser et structurer les connaissances qualifiées (ontologie, graphe). *Réf. : `GSIE/RESEARCH/README.md` (sources scientifiques), `GSIE/KNOWLEDGE/` (base structurée)* |
| Correlation Engine | Croiser automatiquement les données multi-domaines. *Réf. : `GSIE/RESEARCH/RESEARCH_METHOD.md` (modélisation conceptuelle des corrélations)* |
| Reasoning Engine | Produire des conclusions par inférence explicite et auditable. *Réf. : `GSIE/ENGINES/REASONING_ENGINE/REASONING_ENGINE.md`* |
| Diagnostic Engine | Synthétiser un diagnostic stationnel/sylvicole à partir des conclusions. *Réf. : `GSIE/ENGINES/DIAGNOSTIC_ENGINE/DIAGNOSTIC_ENGINE.md`* |
| Recommendation Engine | Proposer des recommandations d'action contournables et justifiées. *Réf. : `GSIE/ENGINES/RECOMMENDATION_ENGINE/RECOMMENDATION_ENGINE.md`* |
| Validation Engine | Valider la conformité de toute sortie avant présentation à l'utilisateur. *Réf. : `GSIE/ENGINES/VALIDATION_ENGINE/VALIDATION_ENGINE.md`* |

**Moteurs domaine (alimentent le raisonnement) :**

| Moteur | Responsabilité |
|---|---|
| GIS Engine | Données géospatiales (parcelles, relief, hydrographie). *Réf. : `GSIE/DATASETS/README.md` (catalogue des datasets géospatiaux), `GSIE/ENGINES/GIS_ENGINE/GIS_ENGINE.md`* |
| Climate Engine | Données climatiques et bioclimatiques (historiques + projections). *Réf. : `GSIE/DATASETS/README.md` (catalogue des datasets climatiques), `GSIE/ENGINES/CLIMATE_ENGINE/CLIMATE_ENGINE.md`* |
| Pedology Engine | Données pédologiques (texture, pH, drainage, réserve utile). *Réf. : `GSIE/DATASETS/README.md` (catalogue des datasets pédologiques), `GSIE/ENGINES/PEDOLOGY_ENGINE/PEDOLOGY_ENGINE.md`* |
| Botanical Engine | Taxonomie, nomenclature et autécologie des essences. *Réf. : `GSIE/DATASETS/README.md` (catalogue des datasets botaniques), `GSIE/ENGINES/BOTANICAL_ENGINE/BOTANICAL_ENGINE.md`* |
| Forest Dynamics Engine | Croissance et dynamique des peuplements forestiers. *Réf. : `GSIE/RESEARCH/README.md` (travaux sur la dendrométrie et croissance), `GSIE/ENGINES/FOREST_DYNAMICS_ENGINE/FOREST_DYNAMICS_ENGINE.md`* |
...
│  *Réf. : `GSIE/DATASETS/README.md` (catalogue des datasets   │
...
- **Filtre amont obligatoire :** l'Evidence Engine est le premier
  ...
  est documenté dans `GSIE/RESEARCH/RESEARCH_METHOD.md`.
...
- Il ne décrit pas le détail interne de chaque moteur (`GSIE/ENGINES/`).
...
Chaque domaine est sourcé dans `GSIE/RESEARCH/` (travaux scientifiques,
bibliographie) et `GSIE/DATASETS/` (jeux de données référencés). L'état
...
|---|---|---|---|
| Écologie forestière et stationnelle | Diagnostic, Forest Dynamics | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |
| Pédologie | Pedology | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |
| Dendrométrie et croissance | Forest Dynamics | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |
| Climatologie et bioclimatologie | Climate | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |
| Botanique et taxonomie | Botanical | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |
| Géospatial (SIG) | GIS | — | `GSIE/DATASETS/README.md` (à enrichir) |
| Pathologie forestière | (futur moteur domaine) | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |
| Entomologie forestière | (futur moteur domaine) | `GSIE/RESEARCH/README.md` (à enrichir) | `GSIE/DATASETS/README.md` (à enrichir) |

### Documents de référence actuellement disponibles

| Document | Rôle | Chemin |
|---|---|---|
| Research Method | Pipeline officiel d'évaluation scientifique (recherche → collecte → évaluation → niveau de preuve → modélisation → validation → intégration) | `GSIE/RESEARCH/RESEARCH_METHOD.md` |
| Research README | Cadre des travaux scientifiques et bibliographiques | `GSIE/RESEARCH/README.md` |
| Datasets README | Cadre du catalogue des jeux de données référencés | `GSIE/DATASETS/README.md` |
...
`GSIE/DATASETS/` au fur et à mesure de l'intégration :

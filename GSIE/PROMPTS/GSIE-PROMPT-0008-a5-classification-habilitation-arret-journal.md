# GSIE-PROMPT-0008 — Contre-audit n°2, A5 — Classification, habilitation R5, arrêt, journal
...
Vérifier la gouvernance opérationnelle du risque élevé.

Rappels : aucun rôle n'était responsable de la classification ; aucune
procédure, aucun réexamen, aucun recours. L'« autorisation humaine qualifiée »
n'était pas définie, l'arrêt d'urgence n'avait pas de délai maximal, et le
journal n'était ni inviolable ni indépendant du composant surveillé.

Scénario imposé : un banc d'essai Ignis pilote une vanne ; le journal est écrit
par le même service sur le même hôte ; le disque sature ; les écritures
échouent en silence ; le service continue de commander. Le texte l'empêche-t-il ?

# GSIE-PROMPT-0007 — Contre-audit n°2, A4 — Taxonomie et classes R0–R5
...
| Constats couverts | C-09, C-15, C-16 |
...
Vérifier la solidité de la classification du risque.

Rappels : les huit notions du §5 n'étaient pas mises en correspondance avec les
six classes du §6 ; « Publication » n'avait pas de classe ; le libellé R4 ne
mentionnait pas la publication scientifique ; une exécution R3 hors usage réel
n'était ni autorisée ni interdite.

Test imposé : classer sept cas réels avec la matrice actuelle — export PDF d'un
diagnostic brouillon, mise en quarantaine automatique, suggestion sylvicole,
pré-remplissage d'un scénario de martelage validé par défaut, envoi d'une carte
de risque au SDIS pendant un feu réel, réentraînement nocturne, publication
d'une corrélation comme connaissance canonique. Un cas non classable vaut P1.

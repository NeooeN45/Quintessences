# GSIE-PROMPT-0009 — Contre-audit n°2, A6 — Régime temporel et apprentissage
...
| Constats couverts | C-08, C-11 |
| Orchestrateur | Architecte |
| Relecteur | Architecte puis Fondateur |
| Verdict rendu | FAVORABLE |
| Rapport consolidé | `23_QUALITY_MANAGEMENT/AUDITS/2026-07-25_CONTRE_AUDIT_2_RFC_0023_0026.md` |

## Mission

Vérifier le bornage dans le temps et l'interdiction d'auto-modification.

Rappels : le régime « des six premiers mois » n'avait ni date de départ, ni
terme, ni règle à échéance, et ses libellés à l'indicatif se lisaient comme une
autorisation en vigueur. L'adverbe « silencieusement » réduisait l'interdiction
d'apprentissage à une exigence de journalisation, plus faible que
`AI_CONSTITUTION.md` IA-4.

Scénario imposé : un mécanisme ajuste un coefficient de croissance, écrit
l'ajustement au journal, un humain le valide en trois secondes. `GSIE-CON-002`
exige que toute valeur soit sourcée. Le texte l'empêche-t-il ?

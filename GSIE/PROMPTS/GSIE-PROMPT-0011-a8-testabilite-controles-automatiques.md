# GSIE-PROMPT-0011 — Contre-audit n°2, A8 — Testabilité et contrôles automatiques
...
| Constats couverts | C-05, C-06, C-14 |
...
Vérifier que les exigences sont mécaniquement vérifiables.

Rappels : `RFC-0024` n'avait aucune section « documents impactés » ni critère
machine-vérifiable ; l'autorité demandée pour `VISION.md` était inexprimable
dans le registre (borne 0–100, constitution = 100) ; le test anti-régression
d'identité était incompatible avec la conservation des éditions antérieures.

Travail imposé : lire `tools/check_source_of_truth.py` et
`.github/workflows/ci.yml`, et vérifier que les contrôles exigés par les
critères d'acceptation y sont réellement branchés et bloquants.

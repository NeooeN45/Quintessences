# GSIE-PROMPT-0010 — Contre-audit n°2, A7 — Données, licences, conformité
...
| Constats couverts | C-12, C-18, C-19 |
...
Vérifier les non-négociables de propriété intellectuelle.

Rappels : « les données utilisateurs ne sont pas revendues » et « aucune
exclusivité totale » étaient contournables ; `LICENSE`, `19_LEGAL/` et
`README.md` § *Licence* étaient absents des documents impactés ; le §7.3 était
muet sur la base légale, la sous-traitance et les transferts hors UE.

Test imposé : confronter la clause actuelle à cinq contournements — partage
gratuit à un partenaire de recherche, dérivé agrégé prétendument anonymisé,
transfert lors d'une cession de société, licence à un financeur pour ses
finalités propres, entraînement d'un modèle tiers.

Vérifier aussi le scénario D-1 : la vérifiabilité externe des composants dont
la sortie fonde une affirmation scientifique publiée.

Aucun avis juridique n'est rendu : seules des lacunes documentaires sont
signalées.

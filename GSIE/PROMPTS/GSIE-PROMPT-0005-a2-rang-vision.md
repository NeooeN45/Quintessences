# GSIE-PROMPT-0005 — Contre-audit n°2, A2 — Rang de la Vision
...
Vérifier la clôture du constat **C-02 (P0)**.

Rappel : `RFC-0023` §5 plaçait `VISION.md` au-dessus de la Constitution avec
une revue annuelle, créant un canal de modification constitutionnelle hors
procédure RFC, et tranchait une contradiction interne de `GSIE-CON-000` sans
la nommer.

Correction annoncée : `DEC-000033` §3 place Vision et Constitution dans un même
bloc fondateur d'autorité 100, avec primauté de la Constitution.

Scénario imposé : onze mois après adoption, la revue annuelle ajoute un domaine
et un partenariat structurant, sans RFC ni contre-audit. Le texte l'empêche-t-il ?

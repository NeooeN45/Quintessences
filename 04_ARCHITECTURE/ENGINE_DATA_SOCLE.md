...
|---|---|
| `04_ARCHITECTURE/ENGINE_DEVELOPMENT_ORDER.md` (204) | Ordre de développement des 14 moteurs et graphe de dépendances |
| `04_ARCHITECTURE/ENGINE_INTERFACE_CONTRACTS.md` (206) | Contrats d'interface et matrice d'interactions entre moteurs |
| `04_ARCHITECTURE/SCIENTIFIC_DATA_MODEL.md` (205) | Modèle de données scientifique (entités, relations, sources) |
| `04_ARCHITECTURE/ENGINE_COMMUNICATION_PROTOCOL.md` (203) | Protocole de communication entre moteurs |
| `04_ARCHITECTURE/TECHNOLOGY_STACK.md` (202) | Stack technologique (PostgreSQL/PostGIS, Neo4j) |
| `07_KNOWLEDGE/KNOWLEDGE_METHOD.md` (302) | Méthode de gestion des connaissances (KnowledgeObject) |
| `07_KNOWLEDGE/FOREST_ONTOLOGY.md` (303) | Ontologie forestière par domaine S-6 |
| `07_KNOWLEDGE/KNOWLEDGE_GRAPH_SPECIFICATION.md` (304) | Spécification du graphe de connaissances (nœuds, arêtes) |
| `08_DATASETS/DATASET_CATALOG.md` (305) | Catalogue des 24 datasets (DS-001 à DS-024) |

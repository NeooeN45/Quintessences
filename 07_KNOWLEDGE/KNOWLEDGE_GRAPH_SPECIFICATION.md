...
| **Documents connexes** | `07_KNOWLEDGE/KNOWLEDGE_METHOD.md` (302), `07_KNOWLEDGE/FOREST_ONTOLOGY.md` (303), `04_ARCHITECTURE/ENGINE_INTERFACE_CONTRACTS.md` (206), `01_DIRECTIVES/ACTIVE/GSIE-DIR-0006.md` |
...
- `04_ARCHITECTURE/ENGINE_INTERFACE_CONTRACTS.md` — Livrable 206 (contrats d'interface)
- `07_KNOWLEDGE/KNOWLEDGE_METHOD.md` — Livrable 302 (méthode de gestion des connaissances)
- `07_KNOWLEDGE/FOREST_ONTOLOGY.md` — Livrable 303 (ontologie forestière)
- `09_ENGINES/KNOWLEDGE_ENGINE/` — Documentation du Knowledge Engine

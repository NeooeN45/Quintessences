...
| **Documents connexes** | `07_KNOWLEDGE/KNOWLEDGE_METHOD.md` (302), `07_KNOWLEDGE/KNOWLEDGE_GRAPH_SPECIFICATION.md` (304), `06_RESEARCH/RESEARCH_METHOD.md` (301), `06_RESEARCH/EVIDENCE_FRAMEWORK.md` (306), `08_DATASETS/DATASET_CATALOG.md` (305) |
...
artefact de code. Elle vit dans `07_KNOWLEDGE/` et est consommée par les
